...
- Issue with lcov and genhtml was fixed in ncs-zephyr image. Due to the changes in the v3.4.0 those
  two, system installed tools, were in mismatch with the perl provided by the nrfutil
  toolchain-manager.
...
- Add support for following ncs-zephyr versions:
  - v3.4.0
- Add JLink support to the vanilla-zephyr Docker image.

#### Changed

- OpenOCD in the vanilla-zephyr Docker image is now part of the CI image, before it was only part of
  the DEV image.
...
- Upgrade to the latest version of Doxygen (v1.14.0) in both ncs-zephyr and vanilla-zephyr.
...
- Previous release added support only for Zephyr v4.1.0, this one adds support also for Zephyr
  v4.2.0.
...
[Unreleased]: https://github.com/IRNAS/irnas-docker-software/compare/v1.24.2...HEAD

[1.24.2]: https://github.com/IRNAS/irnas-docker-software/compare/v1.24.1...v1.24.2
